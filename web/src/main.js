...
var _user$project$Config$excludedPlayers = {
	ctor: '::',
	_0: {firstName: 'Angela', lastName: 'Hofer'},
	_1: {
		ctor: '::',
		_0: {firstName: 'Ritta', lastName: 'Khamis'},
		_1: {
			ctor: '::',
			_0: {firstName: 'Gabriele', lastName: 'Käferböck'},
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$Config$numberOfGuests = 4;
var _user$project$Config$scrapingLink = 'https://softaware-randomizer-api.azurewebsites.net/api/scrape?code=yBwvvbq/TaZO8wj0TUvnMjdaZTUKq64oSe14qaK0QL8IicRLLdDZLw==';

var _user$project$Model$defaultModel = {players: _elm_lang$core$Dict$empty, lineUp: _elm_lang$core$Maybe$Nothing, error: _elm_lang$core$Maybe$Nothing, loading: false, mdl: _debois$elm_mdl$Material$model};
var _user$project$Model$playerOrder = F2(
	function (a, b) {
		var _p0 = a;
		if (_p0.ctor === 'Employee') {
			var _p1 = b;
			if (_p1.ctor === 'Employee') {
				return A2(_elm_lang$core$Basics$compare, _p0._0.lastName, _p1._0.lastName);
			} else {
				return _elm_lang$core$Basics$LT;
			}
		} else {
			var _p2 = b;
			if (_p2.ctor === 'Employee') {
				return _elm_lang$core$Basics$GT;
			} else {
				return A2(_elm_lang$core$Basics$compare, _p0._0.number, _p2._0.number);
			}
		}
	});
var _user$project$Model$orderedPlayers = function (model) {
	return A2(
		_elm_lang$core$List$sortWith,
		F2(
			function (a, b) {
				return A2(_user$project$Model$playerOrder, a.object, b.object);
			}),
		_elm_lang$core$Dict$values(model.players));
};
var _user$project$Model$selectedPlayers = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (_) {
			return _.object;
...
var _user$project$Model$isRandomizable = function (model) {
	return _elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(
			_user$project$Model$selectedPlayers(model)),
		2) > -1;
};
var _user$project$Model$toggleSelection = function (selectable) {
	return _elm_lang$core$Native_Utils.update(
		selectable,
		{selected: !selectable.selected});
};
var _user$project$Model$displayName = function (player) {
	var _p3 = player;
	if (_p3.ctor === 'Employee') {
		return _p3._0.firstName;
	} else {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'Gast ',
			_elm_lang$core$Basics$toString(_p3._0.number));
	}
};
var _user$project$Model$playerId = function (player) {
	var _p4 = player;
	if (_p4.ctor === 'Employee') {
		var _p5 = _p4._0;
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_p5.firstName,
			A2(_elm_lang$core$Basics_ops['++'], '.', _p5.lastName));
	} else {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'Guest.',
			_elm_lang$core$Basics$toString(_p4._0.number));
	}
};
var _user$project$Model$EmployeeInfo = F3(
	function (a, b, c) {
		return {firstName: a, lastName: b, pictureUrl: c};
	});
var _user$project$Model$GuestInfo = function (a) {
	return {number: a};
};
var _user$project$Model$Selectable = F2(
	function (a, b) {
		return {object: a, selected: b};
	});
var _user$project$Model$DoubleType = F2(
	function (a, b) {
		return {teamA: a, teamB: b};
	});
var _user$project$Model$SingleType = F2(
	function (a, b) {
		return {player1: a, player2: b};
	});
var _user$project$Model$Model = F5(
	function (a, b, c, d, e) {
		return {players: a, lineUp: b, error: c, loading: d, mdl: e};
	});
var _user$project$Model$Double = function (a) {
	return {ctor: 'Double', _0: a};
};
var _user$project$Model$Single = function (a) {
	return {ctor: 'Single', _0: a};
};
var _user$project$Model$Guest = function (a) {
	return {ctor: 'Guest', _0: a};
};
var _user$project$Model$Employee = function (a) {
	return {ctor: 'Employee', _0: a};
};
var _user$project$Model$HttpError = function (a) {
	return {ctor: 'HttpError', _0: a};
};

var _user$project$Message$EmployeeInfosLoaded = function (a) {
	return {ctor: 'EmployeeInfosLoaded', _0: a};
};
var _user$project$Message$LoadEmployees = {ctor: 'LoadEmployees'};
var _user$project$Message$SelectionChanged = function (a) {
	return {ctor: 'SelectionChanged', _0: a};
};
var _user$project$Message$ClearLineUp = {ctor: 'ClearLineUp'};
var _user$project$Message$CreateLineUp = function (a) {
	return {ctor: 'CreateLineUp', _0: a};
};
var _user$project$Message$Randomize = {ctor: 'Randomize'};

var _user$project$Update$decodeJson = _elm_lang$core$Json_Decode$list(
	A4(
		_elm_lang$core$Json_Decode$map3,
		_user$project$Model$EmployeeInfo,
		A2(
			_elm_lang$core$Json_Decode$at,
			{
				ctor: '::',
		...
		A2(
			...
			_elm_lang$core$Json_Decode$string)));
var _user$project$Update$loadEmployees = function () {
	var url = _user$project$Config$scrapingLink;
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Message$EmployeeInfosLoaded,
		A2(_elm_lang$http$Http$get, url, _user$project$Update$decodeJson));
}();
var _user$project$Update$togglePlayerSelection = F2(
	function (players, player) {
		return A3(
			_elm_lang$core$Dict$update,
			_user$project$Model$playerId(player),
			_elm_lang$core$Maybe$map(
				function (p) {
					return _elm_lang$core$Native_Utils.update(
						p,
...
var _user$project$Update$filterRelevant = function (employees) {
	return A2(
		_elm_lang$core$List$filter,
		function (e) {
			return !A2(
				...
				_user$project$Config$excludedPlayers);
		},
		employees);
};
var _user$project$Update$refreshPlayers = F2(
	function (model, employees) {
		var guests = A2(
			_elm_lang$core$List$map,
			function (g) {
				return {
					selected: false,
					object: _user$project$Model$Guest(
						_user$project$Model$GuestInfo(g))
				};
			},
			A2(_elm_lang$core$List$range, 1, _user$project$Config$numberOfGuests));
		var emps = A2(
			_elm_lang$core$List$map,
			function (e) {
				return {
					selected: false,
					object: _user$project$Model$Employee(e)
				};
			},
			_user$project$Update$filterRelevant(employees));
		var players = _elm_lang$core$Dict$fromList(
			A2(
				_elm_lang$core$List$map,
				function (p) {
					return {
						ctor: '_Tuple2',
						_0: _user$project$Model$playerId(p.object),
						_1: p
					};
				},
				A2(_elm_lang$core$Basics_ops['++'], emps, guests)));
		return _elm_lang$core$Native_Utils.update(
			model,
			{players: players, error: _elm_lang$core$Maybe$Nothing, loading: false});
	});
var _user$project$Update$createLineUp = F2(
		...
		var lineUp = function () {
			...
			if (_p0.ctor === '[]') {
				...
				if (_p0._1.ctor === '[]') {
					...
					if (_p0._1._1.ctor === '[]') {
						return _elm_lang$core$Maybe$Just(
							_user$project$Model$Single(
								A2(_user$project$Model$SingleType, _p0._0, _p0._1._0)));
					} else {
						if (_p0._1._1._1.ctor === '[]') {
							...
							return _elm_lang$core$Maybe$Just(
								_user$project$Model$Double(
									A2(
										_user$project$Model$DoubleType,
										{player1: _p0._0, player2: _p0._1._0},
										{player1: _p0._1._1._0, player2: _p0._1._1._1._0})));
						}
					}
				}
			}
...
var _user$project$Update$randomize = function (model) {
	return A2(
		_elm_lang$core$Random$generate,
		function (players) {
			return _user$project$Message$CreateLineUp(players);
		},
		...
		switch (_p1.ctor) {
			case 'Randomize':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Update$randomize(model)
				};
			case 'ClearLineUp':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{lineUp: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'CreateLineUp':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Update$createLineUp, model, _p1._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'LoadEmployees':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Update$loadEmployees};
			case 'EmployeeInfosLoaded':
				var _p2 = _p1._0;
				if (_p2.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Update$refreshPlayers, model, _p2._0),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								error: _elm_lang$core$Maybe$Just(
									_user$project$Model$HttpError(_p2._0))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							players: A2(_user$project$Update$togglePlayerSelection, model.players, _p1._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Update$init = function (defaultModel) {
	return A2(
		_user$project$Update$update,
		_user$project$Message$LoadEmployees,
		_elm_lang$core$Native_Utils.update(
			defaultModel,
			{loading: true}));
};

var _user$project$View$errorMessage = function (error) {
	var _p0 = error;
	if (_p0.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$div,
...
var _user$project$View$pct100 = _rtfeldman$elm_css$Css$pct(100);
var _user$project$View$white = _rtfeldman$elm_css$Css$hex('ffffff');
var _user$project$View$playerPadding = 5;
var _user$project$View$playerColumns = 4;
var _user$project$View$selectionToVisibility = function (selected) {
	return {
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$opacity(
			_rtfeldman$elm_css$Css$num(
				selected ? 1 : 0.47)),
		_1: {ctor: '[]'}
	};
};
var _user$project$View$selectionOpacity = function (selectable) {
	return _user$project$View$selectionToVisibility(selectable.selected);
};
var _user$project$View$styles = function (_p1) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p1));
};
var _user$project$View$renderEmployee = function (employee) {
	return A2(
		_elm_lang$html$Html$img,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$src(employee.pictureUrl),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$alt(employee.firstName),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Message$SelectionChanged(
								_user$project$Model$Employee(employee))),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$View$renderGuest = function (guest) {
	return A2(
		_elm_lang$html$Html$img,
		{
			ctor: '::',
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Attributes$src(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(guest.number),
							'.png'))),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Message$SelectionChanged(
								_user$project$Model$Guest(guest))),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$View$renderPlayer = function (selectable) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			_0: _user$project$View$styles(
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_0: A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString((100 / _user$project$View$playerColumns) | 0),
									A2(
										_elm_lang$core$Basics_ops['++'],
										'% - ',
										A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(2 * _user$project$View$playerPadding),
											'px)'))))),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$margin(
								_rtfeldman$elm_css$Css$px(_user$project$View$playerPadding)),
							_1: {
								ctor: '::',
					...
					_user$project$View$selectionOpacity(selectable))),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: function () {
				var _p2 = selectable.object;
				if (_p2.ctor === 'Employee') {
					return _user$project$View$renderEmployee(_p2._0);
				} else {
					return _user$project$View$renderGuest(_p2._0);
				}
			}(),
			_1: {ctor: '[]'}
		});
							...
							_1: {
								...
								_1: {
									...
									_0: A4(
										...
										A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.17)),
									_1: {ctor: '[]'}
								}
							}
						}
	...
	},
	{
		...
		_0: A2(
			_elm_lang$html$Html$img,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src('./assets/randomzr.png'),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'}),
...
var _user$project$View$lineUp = function (optionalLineUp) {
	var _p3 = optionalLineUp;
	if (_p3.ctor === 'Nothing') {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$Message$ClearLineUp),
				_1: {
					ctor: '::',
					_0: _user$project$View$styles(
						{
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _user$project$View$styles(
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$View$white),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$width(
										_rtfeldman$elm_css$Css$vw(80)),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$left(
											_rtfeldman$elm_css$Css$vw(10)),
										_1: {
											ctor: '::',
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src('./assets/lineup.png'),
								_1: {
									ctor: '::',
									_0: _user$project$View$styles(
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: A2(_rtfeldman$elm_css$Css$property, 'object-fit', 'contain'),
													_1: {
														ctor: '::',
										...
										if (_p4.ctor === 'Single') {
											...
											return A2(
												...
												{ctor: '[]'},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														_user$project$Model$displayName(_p5.player1)),
													_1: {
														ctor: '::',
														_0: A2(
															_elm_lang$html$Html$img,
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$src('./assets/soccer-table.jpg'),
																_1: {
																	ctor: '::',
																	_0: _user$project$View$styles(
																		{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																_user$project$Model$displayName(_p5.player2)),
															_1: {ctor: '[]'}
														}
													}
												});
											...
											return A2(
												...
												{ctor: '[]'},
												{
													...
													_0: _elm_lang$html$Html$text(
														A2(
															_elm_lang$core$Basics_ops['++'],
															_user$project$Model$displayName(_p6.teamA.player1),
															A2(
																_elm_lang$core$Basics_ops['++'],
																'&',
																_user$project$Model$displayName(_p6.teamA.player2)))),
													_1: {
														ctor: '::',
														_0: A2(
															_elm_lang$html$Html$img,
														...
														_1: {
															...
															_0: _elm_lang$html$Html$text(
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	_user$project$Model$displayName(_p6.teamB.player1),
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		'&',
																		_user$project$Model$displayName(_p6.teamB.player2)))),
															_1: {ctor: '[]'}
														}
													}
												});
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$errorMessage(model.error),
			_1: {
				ctor: '::',
				_0: _user$project$View$lineUp(model.lineUp),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						...
						},
						{
							...
							_1: {
								...
								_0: _debois$elm_mdl$Material_Spinner$spinner(
									{
										ctor: '::',
										_0: _debois$elm_mdl$Material_Spinner$active(model.loading),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										A2(
											_elm_lang$core$List$map,
											_user$project$View$renderPlayer,
											_user$project$Model$orderedPlayers(model))),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_0: _elm_lang$html$Html_Attributes$disabled(
													!_user$project$Model$isRandomizable(model)),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_user$project$Message$Randomize),
													_1: {
														ctor: '::',
														_0: _user$project$View$styles(
															{
																...
																_1: {
																	...
																	_1: {
																		ctor: '::',
																		_0: _rtfeldman$elm_css$Css$backgroundColor(
																			A3(_rtfeldman$elm_css$Css$rgb, 119, 179, 0)),
																		_1: {
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$color(_user$project$View$white),
																			_1: {
																				ctor: '::',
																						...
																						_1: {
																							...
																							_1: {
																								...
																								_1: {
																									...
																									_1: {
																										ctor: '::',
																										_0: A2(_rtfeldman$elm_css$Css$property, 'transition', 'box-shadow 0.2s cubic-bezier(0.4, 0, 0.2, 1)'),
																										_1: {
																											ctor: '::',
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Update$init(_user$project$Model$defaultModel),
